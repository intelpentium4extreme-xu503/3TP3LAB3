...
set yrange [-36:36]                     # set y plot range
...
set yrange [-36:36]                      # set y plot range
set xrange [0:511]                       # set x plot range
plot '../data/example.dat' using 1:3 with lines lt 1 lw 2 lc rgb '#888888' notitle,\
     '../data/example.dat' using 1:4 with lines lt 1 lw 2 lc rgb '#DD00DD' notitle

# spectrum
set ylabel 'Spectrum'                    # set y-axis label
set xlabel 'Frequency bin'               # set x-axis label for this plot
set yrange [0:6]                         # set y plot range
set xrange [0:255]                       # set x plot range (change range as you see fit)
plot '../data/example.dat' using 1:5 with lines lt 1 lw 3 lc rgb '#888888' notitle,\
     '../data/example.dat' using 1:6 with lines lt 1 lw 3 lc rgb '#DD00DD' notitle
